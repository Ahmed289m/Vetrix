      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <div className="flex justify-between mt-1.5">
            {[5, 7, 10, 12].map((v) => (
              <button
                key={v}
                onClick={() => setDehydration(String(v))}
        ...
        <div>
          ...
          <input
            type="number"
            value={ongoingLosses}
            onChange={(e) => setOngoingLosses(e.target.value)}
            placeholder="0"
            className="w-full px-3 py-2.5 rounded-xl bg-muted/30 border border-border/50 text-sm outline-none focus:border-emerald/30 transition-colors"
          />
          <p className="text-[10px] text-muted-foreground mt-1">
            Vomiting, diarrhea, drains
          </p>
        </div>
      </div>
        ...
        >
          <div className="flex-1">
            <div className="flex justify-between mb-1">
              ...
              <span
                className={`text-[10px] font-bold uppercase ${dh <= 5 ? "text-emerald" : dh <= 8 ? "text-orange" : "text-coral"}`}
              >
                {dh <= 5
                  ? "Mild"
                  : dh <= 8
        ...
        {w > 0 && (
          ...
          >
            <div className="p-4 rounded-xl bg-cyan/5 border border-cyan/20 text-center">
              ...
              <motion.p
                className="text-xl font-extrabold text-cyan mt-1 tabular-nums"
                key={deficitMl}
                initial={{ scale: 1.2 }}
                animate={{ scale: 1 }}
              >
            ...
            <div className="p-4 rounded-xl bg-emerald/5 border border-emerald/20 text-center">
              ...
              <motion.p
                className="text-xl font-extrabold text-emerald mt-1 tabular-nums"
                key={maintenanceMl}
                initial={{ scale: 1.2 }}
                animate={{ scale: 1 }}
              >
                {maintenanceMl.toFixed(0)}
              </motion.p>
            ...
            <div className="p-4 rounded-xl bg-orange/5 border border-orange/20 text-center">
              ...
              <motion.p
                className="text-xl font-extrabold text-orange mt-1 tabular-nums"
                key={totalFluid24h}
                initial={{ scale: 1.2 }}
                animate={{ scale: 1 }}
              >
                {totalFluid24h.toFixed(0)}
              </motion.p>
              <p className="text-[10px] text-muted-foreground">mL</p>
            </div>
            <div className="p-4 rounded-xl gradient-emerald-cyan text-center glow-emerald">
              <p className="text-[10px] font-bold uppercase text-primary-foreground/70">
                Rate
              </p>
              <motion.p
                className="text-xl font-extrabold text-primary-foreground mt-1 tabular-nums"
                key={ratePerHour}
                initial={{ scale: 1.2 }}
                animate={{ scale: 1 }}
              >
                ...
                <div className="pt-4 space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative h-10 rounded-xl overflow-hidden bg-muted/20 border border-border/30">
                      ...
                      <motion.div
                        ...
                        style={{ left: `${phase1Progress}%`, right: 0 }}
                      >
                    ...
                    <div className="flex justify-between mt-1">
                      ...
                      <span
                        className="text-[10px] text-emerald font-mono font-bold"
                        style={{ marginLeft: `${phase1Progress - 8}%` }}
                      >
                        {phase1Hours}h
                      </span>
                      <span className="text-[10px] text-muted-foreground font-mono">
                    ...
                    >
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="flex justify-between text-xs">
                          ...
                          <span className="font-bold tabular-nums">
                            {phase1Maintenance.toFixed(0)} mL
                          </span>
                        </div>
                        {phase1Losses > 0 && (
                          <div className="flex justify-between text-xs">
                            ...
                            <span className="font-bold tabular-nums">
                              {phase1Losses.toFixed(0)} mL
                            </span>
                          </div>
                        )}
                        <div className="pt-2 border-t border-emerald/20 flex justify-between text-xs">
                          <span className="font-bold text-emerald">Total</span>
                          <span className="font-extrabold text-emerald tabular-nums">
                            {phase1Total.toFixed(0)} mL
                          </span>
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="flex justify-between text-xs">
                          ...
                          <span className="font-bold tabular-nums">
                            {phase2Maintenance.toFixed(0)} mL
                          </span>
                        </div>
                        {phase2Losses > 0 && (
                          <div className="flex justify-between text-xs">
                            ...
                            <span className="font-bold tabular-nums">
                              {phase2Losses.toFixed(0)} mL
                            </span>
                          </div>
                        )}
                        <div className="pt-2 border-t border-cyan/20 flex justify-between text-xs">
                          <span className="font-bold text-cyan">Total</span>
                          <span className="font-extrabold text-cyan tabular-nums">
                            {phase2Total.toFixed(0)} mL
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="p-3 rounded-xl bg-muted/20 border border-border/30">
                    ...
                    <ul className="space-y-1">
                      ...
                      <li className="text-xs text-muted-foreground">
                        • Adjust rate based on clinical response and ongoing
                        losses
                      </li>
                      {species === "cat" && (
                        <li className="text-xs text-orange">
                          • ⚠️ Cats are sensitive to fluid overload — monitor
                          closely for respiratory changes
                        </li>
                      )}
                      {dh >= 10 && (
                        <li className="text-xs text-coral">
                          • ⚠️ Severe dehydration — consider IV bolus of 10–20
                          mL/kg over 15–20 min initially
                        </li>
                      )}
                    </ul>
                  </div>
