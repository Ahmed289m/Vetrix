...
const Sheet = ({ open, onOpenChange, children, ...props }: React.ComponentProps<typeof SheetPrimitive.Root>) => (
          ...
          {open && (
            <>
              ...
              <SheetPrimitive.Content asChild ref={ref} {...props} forceMount>
                <motion.div
                   variants={variantAnimations[side as keyof typeof variantAnimations]}
                   initial="initial"
                   animate="animate"
                   exit="exit"
