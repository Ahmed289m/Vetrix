...
import { Send, Sparkles, Loader2, Zap, FileText, Pill, Calendar, Mic, Bot, PawPrint } from "lucide-react";
...
const initialMessages: Message[] = [
  {
    id: "1",
    role: "assistant",
    content: "Hello! I'm **Vetra AI**, your intelligent clinic assistant. I can help you with:\n\n- 🔍 Patient records & history\n- 💊 Drug dosages & interactions\n- 📅 Today's schedule\n- 🚨 Emergency protocols\n\nWhat would you like to know?",
    timestamp: new Date(),
  },
];
      ...
      <div className="w-full max-w-3xl flex-1 flex flex-col min-h-0">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-lg font-extrabold tracking-tight gradient-text">Vetra AI Assistant</h3>
