...
const translations: Translations = {
  ...
  "search_prescriptions": { en: "Search prescriptions...", ar: "بحث الوصفات..." },
  ...
  "surgeries": { en: "surgeries", ar: "عمليات" },
  "consultations": { en: "consultations", ar: "استشارات" },
  "scheduled_today": { en: "scheduled today", ar: "مجدولة اليوم" },
